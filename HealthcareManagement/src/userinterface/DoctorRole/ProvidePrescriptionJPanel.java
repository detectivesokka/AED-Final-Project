...
public class ProvidePrescriptionJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        supplierjComboBox.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(supplierjComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if (prescription.equals("")) {
            ...
            if (dialogResult == JOptionPane.YES_OPTION) {
                ...
                this.request.setMedCharges(amount);

                Organization org = null;
                for (HealthcareNetwork n : this.ecosystem.getNetworks()) {
    ...
    private void viewMedicinesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewMedicinesActionPerformed
        ...
        if (!supplierjComboBox.getSelectedItem().toString().equals("Select Supplier")) {
            for (HealthcareNetwork n : this.ecosystem.getNetworks()) {
                if (n.getEnterpriseDirectory().getEnterpriseList().contains(this.enterprise)) {
                    for (Enterprise e : n.getEnterpriseDirectory().getEnterpriseList()) {

                        if (e instanceof SupplierEnterprise
                                & e.getName().equals(supplierjComboBox.getSelectedItem().toString())) {
//                            HealthcareNetwork.out.println(e.getName());
                            SupplierEnterprise pe = (SupplierEnterprise) e;
//                            HealthcareNetwork.out.println(pe.getName());
                            Object[] row = new Object[2];
                            for (Medicine m : pe.getSupplier().getMeds()) {
//                                HealthcareNetwork.out.println(m.getMedicineName());
                                row[0] = m;
    ...
    private void populateTable() {
        ...
        txtMedicalCondition1.setText(request.getReason());

    }

    private void populateSupplierJCombo() {
        supplierjComboBox.removeAllItems();
        supplierjComboBox.addItem("Select Supplier");
        for (HealthcareNetwork n : this.ecosystem.getNetworks()) {
            if (n.getEnterpriseDirectory().getEnterpriseList().contains(this.enterprise)) {
                for (Enterprise e : n.getEnterpriseDirectory().getEnterpriseList()) {

                    if (e.getEnterpriseType().getValue().contains("Supplier")) {
                        supplierjComboBox.addItem(e.getName());
                    }
