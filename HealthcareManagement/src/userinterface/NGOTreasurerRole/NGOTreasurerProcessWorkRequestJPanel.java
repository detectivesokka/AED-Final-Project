 ...
 */
public class NGOTreasurerProcessWorkRequestJPanel extends javax.swing.JPanel {

    private JPanel jPanel;
    private NGOFundRequest NGOFundRequest;

    public NGOTreasurerProcessWorkRequestJPanel(JPanel jPanel, NGOFundRequest fundRequest) {
        initComponents();

        ImageIcon icon = new javax.swing.ImageIcon(getClass().getResource("/ImagesLatest/Businesswoman.gif"));
        icon.getImage().flush();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("TREASURER WORK AREA");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagesLatest/Businesswoman.gif"))); // NOI18N
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if (message.equals("")) {
            ...
            if (dialogResult == JOptionPane.YES_OPTION) {
                ...
                JOptionPane.showMessageDialog(null, "Funds Disbursed Successfully", "Success", JOptionPane.INFORMATION_MESSAGE);
            ...
            NGOTreasurerWorkAreaJPanel dwjp = (NGOTreasurerWorkAreaJPanel) component;
            dwjp.populateTable();
            CardLayout layout = (CardLayout) jPanel.getLayout();
            layout.previous(jPanel);
