...
public class DriverJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(tbdPane, javax.swing.GroupLayout.DEFAULT_SIZE, 501, Short.MAX_VALUE)
        );
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        try {
            ...
            this.driver.getUser().setUserName(fldUsername.getText());
            this.driver.getUser().setPassword(pwd);

            this.driver.setName(fldName.getText());
            this.driver.setAge(Integer.parseInt(fldAge.getText()));
            this.driver.setSex((String) comboSex.getSelectedItem());
            this.driver.setEmail(fldEmail.getText());
